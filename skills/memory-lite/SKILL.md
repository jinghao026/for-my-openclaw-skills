...
name: memory-lite
description: |
  Lightweight memory management for OpenClaw without embeddings or vector search.
  Use to append notes to memory/YYYY-MM-DD.md and MEMORY.md, do simple keyword
...
```bash
python3 scripts/memory_add.py --kind long --text "Important thing to remember"
```

### Search for a keyword
```bash
bash scripts/memory_grep.sh "task OK"
```
...
Original: https://github.com/vellis59/memory-lite
License: MIT

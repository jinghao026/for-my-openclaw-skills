...
def send_email_with_attachments(
    ...
    try:
        ...
        for filename, filepath in attachments:
            ...
            if maintype == 'text':
                # 文本文件
                attachment = MIMEText(file_data.decode('utf-8', errors='ignore'), _subtype=subtype, _charset='utf-8')
            elif maintype == 'image':
                # 图片文件
            ...
            # 添加Content-Disposition头，确保文件名正确显示
